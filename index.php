...
<html>
    ...
    <?php if (isset($_SESSION['success'])) : ?>
      <div class="error success" style="width:220px; height:40px; margin-bottom:5px; margin-top: 0px;">
...
<div class="col-md-4" style="margin-bottom:20px;">
 ...
 <form action="index.php" class="form-control" method="POST" style="width:220px; height:370px;">
     ...
     <div class="input-group" style="margin-bottom: 20px" style="height:50px; width:180px;">
